...
describe('config', function()
  ...
  describe('setup', function()
    it('should use default values when no config provided', function()
      ...
      assert.equals(5000, config.config.max_length)
      assert.is_true(config.config.targets.comment)
      assert.is_true(config.config.targets.string)
      ...
      assert.equals('<leader>th', config.config.keymaps.hover)
      assert.equals('<leader>tc', config.config.keymaps.hover_manual)
      assert.equals('<leader>tr', config.config.keymaps.replace)
      assert.equals('<leader>tt', config.config.keymaps.toggle)
    end)
